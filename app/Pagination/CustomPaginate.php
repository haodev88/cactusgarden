 ...
 * <!-- paginate -->
{{--  @if(isset($append))
   {!! with(new App\Pagination\CustomPaginate($listCate))->render() !!} 
@else
    {!! with(new App\Pagination\CustomPaginate($listCate))->render() !!}
@endif  --}}   
<!-- /-paginate -->
...
class CustomPaginate extends BootstrapThreePresenter {
    ...
    public function getFirst()
    {
        ...
        return $btn = "<a href='".$url.'&abc'."'><button class='btn btn-success ".$btnStatus."'><i class='glyphicon glyphicon-chevron-left'></i> First</button></a>";
    }

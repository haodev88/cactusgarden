                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <div class="pull-right" style="vertical-align: middle">
                                <a class="btn btn-success btn-sm btn-add" href="{!! route('admin_shop.category.create') !!}">
                                    Thêm danh mục
                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tr>
                                        <form action="{!! Route('searchCate') !!}" method="get">                                       
                                            <td colspan="3"><input placeholder="Nhập tiêu đề danh mục cần tìm" name="catename" type="text" class="form-control" /></td>
                            ...
                            @if(isset($append) && !empty($append))
                                @include('cms.blocks.paginate', ['paginator' => $listCate->appends($append)])
                            @else
                                @include('cms.blocks.paginate', ['paginator' => $listCate])
                            @endif    
                        </div>
                    </div>
                </div>

                        ...
                        {!! Form::open(['route'=>['admin_shop.permission.update',$permission['id']],'name'=>'formInput','id'=>'formInput','method'=>'PUT','class'=>'form-horizontal form-label-left','role'=>'form','data-toggle'=>'validator']) !!}
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::text('txtPermission',$permission['name'], ['data-error'=>'Vui lòng nhập dữ liệu','id'=>'txtRole','class'=>'form-control col-md-7 col-xs-12','required'=>'required']) !!} 
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::text('txtDesc',$permission['description'], ['data-error'=>'Vui lòng nhập dữ liệu','id'=>'txtDesc','class'=>'form-control col-md-7 col-xs-12','required'=>'required']) !!} 
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="ln_solid"></div>

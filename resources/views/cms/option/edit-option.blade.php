        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {!! Form::open(['route'=>['admin_shop.option.update','id'=>$option->id],'name'=>'formInput','id'=>'formInput','method'=>'PUT','class'=>'form-horizontal form-label-left','role'=>'form','data-toggle'=>'validator']) !!}
                                    ...
                                    <select name="sltGroup" id="sltGroup" data-error="Vui lòng chọn" required="required" class="select2_single form-control">
                                        ...
                                        @if ($listGroup->count() !=0)
                                            @foreach($listGroup as $group)
                                                @if($option->dt_option_group_id == $group->id)
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::text('txtName',$option->name, ['data-error'=>'Vui lòng nhập dữ liệu','id'=>'txtName','class'=>'form-control col-md-7 col-xs-12','required'=>'required']) !!} 
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="ln_solid"></div>

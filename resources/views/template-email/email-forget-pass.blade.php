...
<body bgcolor="#f7f7f7" style="padding: 0; margin: 0; font-family:Arial,sans-serif;font-size:13px;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f7f7f7">
        ...
        <tr>
            <td>
                <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;" bgcolor="#00c0a5">
                    <tr>
                        <td align="center" style="text-align: center; padding:12px 0px;">
                            <a href="{{ route('home') }}" target="_blank"><img src="{{ asset('public/shop/images/home/logo.png') }}" width="136" border="0" /></a>
                        </td>
                    </tr>
                </table>
            </td>
                                ...
                                <tr>
                                    <td>
                                        <font style="font-family: Arial, sans-serif; color: #333;">
                                            <p style="margin-top: 0; margin-bottom: 10px; font-size: 16px; font-weight: bold; color: #2bc5f8">Chào {{ $findInfo['name'] }}, </p>
                                            ...
                                            <p>Eshop cảm ơn bạn đã ủng hộ.</p>
                                        </font>
                                    </td>
                                </tr>
                                <tr>
